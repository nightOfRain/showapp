...
//#import <NTSharePlugin/NTSharePlugin.h>
#if __has_include(<NTSharePlugin/NTSharePlugin.h>)
#import <NTSharePlugin/NTSharePlugin.h>
#endif
...
#else
@property (nonatomic, strong) UpdateZipViewController *viewController;
...
#if __has_feature(objc_arc)
    self.viewController = [[UpdateZipViewController alloc] init];
#else
    self.viewController = [[[UpdateZipViewController alloc] init] autorelease];
#endif
...
//    return [NTSharePlugin handleOpenURL:url];
//    return YES;
