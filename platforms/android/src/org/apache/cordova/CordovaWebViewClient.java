...
public class CordovaWebViewClient extends WebViewClient {
    ...
    private boolean alreadyClearhistory = false;
    ...
    public void onPageFinished(WebView view, String url) {
		if(!alreadyClearhistory){
			WebBackForwardList backForwardList = view.copyBackForwardList();
			WebHistoryItem atIndex = backForwardList.getItemAtIndex(1);
			if(atIndex != null){
				if(backForwardList != null && backForwardList.getSize() > 1 && backForwardList.getItemAtIndex(1).getUrl().equals(url)){
					view.clearHistory();
					alreadyClearhistory = true;
				}
			}
		}
