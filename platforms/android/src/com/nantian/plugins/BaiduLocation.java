...
public class BaiduLocation extends CordovaPlugin {
    ...
    public BDLocationListener myListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            try {
                ...
                StringBuilder local = new StringBuilder(256); //我只需要经纬度
                sb.append("time : ");
                ...
                local.append(location.getLongitude() +","+location.getLatitude());
    ...
    //            }
             ...
             //   PluginResult pluginResult = new PluginResult(PluginResult.Status.OK, sb.toString());
                PluginResult pluginResult = new PluginResult(PluginResult.Status.OK, local.toString());
