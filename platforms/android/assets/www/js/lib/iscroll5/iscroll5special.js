...
//		}
		...
		rIscroll2.scrollTo(newX, 0);
		this.scrollTo(newX, newY);	// ensures that the last position is rounded
		
		//console.log("a"+this.maxScrollX);
		//console.log("b"+newX);
...
// INSERT POINT: _end
		...
		if ( newX != this.x || newY != this.y ) {
			...
			rIscroll2.scrollTo(newX,0, time, easing);
...
//		rIscroll2.scrollTo(x,0, time, this.options.bounceEasing);
